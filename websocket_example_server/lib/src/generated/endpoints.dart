        ...
        'uploadImage': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['example'] as _i3.ExampleEndpoint).uploadImage(
            session,
            params['imageBytes'],
            params['senderId'],
            params['receiverId'],
        ...
        'fetchImage': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['example'] as _i3.ExampleEndpoint).fetchImage(
            session,
            params['messageId'],
          ),
        ),
        'getMessageById': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['example'] as _i3.ExampleEndpoint).getMessageById(
            session,
            params['messageId'],
          ),
        ),
        'getChatHistory': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['example'] as _i3.ExampleEndpoint).getChatHistory(
            session,
            params['userId'],
        ...
        'echoStream': _i1.MethodStreamConnector(
          ...
          call: (
            ...
            Map<String, Stream> streamParams,
              ...
              (endpoints['example'] as _i3.ExampleEndpoint).echoStream(
            session,
        ...
        'subscribe': _i1.MethodStreamConnector(
          ...
          call: (
            ...
            Map<String, Stream> streamParams,
              ...
              (endpoints['example'] as _i3.ExampleEndpoint).subscribe(
            session,
            params['userId'],
            params['chatPartnerId'],
          ),
